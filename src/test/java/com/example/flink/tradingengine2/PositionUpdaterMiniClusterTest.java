...
public class PositionUpdaterMiniClusterTest {
    ...
    void partialClose_stateIsCorrect() throws Exception {
        ...
        PositionUpdater.ExecReport e3 = new  PositionUpdater.ExecReport(A,S,"o3","f1",SYM,"SELL", 6,110,t3);
    ...
    void fullCycle_flatEmitsDeletes() throws Exception {
        ...
        PositionUpdater.ExecReport e2 = new  PositionUpdater.ExecReport(A,S,"o2","f1",SYM,"BUY",  3,105,t2);
        PositionUpdater.ExecReport e3 = new  PositionUpdater.ExecReport(A,S,"o3","f1",SYM,"SELL", 6,110,t3);
        PositionUpdater.ExecReport e4 = new  PositionUpdater.ExecReport(A,S,"o4","f1",SYM,"SELL", 5, 95,t4);
        ...
        assertTrue(OpenPositionsLotsTestSink.wasDeleted(A, S, SYM, "o3#f1"), "Expected DELETE for lot o3#f1");
