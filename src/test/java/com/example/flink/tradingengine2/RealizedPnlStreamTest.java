...
public class RealizedPnlStreamTest {
    ...
    void partialClose_realizedIs55() throws Exception {
        ...
        PositionUpdater.ExecReport e1 = new PositionUpdater.ExecReport(A,S,"o1","f1",SYM,"BUY",  5,100,t1);
        PositionUpdater.ExecReport e2 = new PositionUpdater.ExecReport(A,S,"o2","f1",SYM,"BUY",  3,105,t2);
        PositionUpdater.ExecReport e3 = new PositionUpdater.ExecReport(A,S,"o3","f1",SYM,"SELL", 6,110,t3); // +55
        ...
        DataStream<PositionUpdater.ExecReport> src = env.fromElements(e1,e2,e3)
                .assignTimestampsAndWatermarks(
                        WatermarkStrategy
                                .<PositionUpdater.ExecReport>forBoundedOutOfOrderness(Duration.ofSeconds(1))
    ...
    void fullCycle_realizedEndsAt50() throws Exception {
        ...
        PositionUpdater.ExecReport e2 = new PositionUpdater.ExecReport(A,S,"o2","f1",SYM,"BUY",  3,105,t2);
        PositionUpdater.ExecReport e3 = new PositionUpdater.ExecReport(A,S,"o3","f1",SYM,"SELL", 6,110,t3); // +55
        PositionUpdater.ExecReport e4 = new PositionUpdater.ExecReport(A,S,"o4","f1",SYM,"SELL", 5, 95,t4); // -20 on remaining long 2; + SHORT 3 opens
        PositionUpdater.ExecReport e5 = new PositionUpdater.ExecReport(A,S,"o5","f1",SYM,"BUY",  3, 90,t5); // +15 covering short 3
        // total = 55 - 20 + 15 = 50
